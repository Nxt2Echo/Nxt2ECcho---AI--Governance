...
const riskConfig = {
  Critical: { icon: AlertTriangle, color: "text-red-400", bg: "bg-red-500/10", border: "border-red-500/20", badge: "critical", glow: "shadow-red-500/20" },
  High: { icon: AlertCircle, color: "text-orange-400", bg: "bg-orange-500/10", border: "border-orange-500/20", badge: "high", glow: "shadow-orange-500/20" },
  Medium: { icon: Thermometer, color: "text-amber-400", bg: "bg-amber-500/10", border: "border-amber-500/20", badge: "medium", glow: "shadow-amber-500/20" },
  Low: { icon: CheckCircle2, color: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/20", badge: "low", glow: "shadow-emerald-500/20" },
};
...
export default function Heatmap() {
  const totalComplaints = heatmapZones.reduce((a, b) => a + b.complaints, 0);
