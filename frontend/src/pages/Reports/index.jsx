...
import { reportTemplates, weeklyStats, complaintTrendData, departmentData } from "@/data/mockData";
...
import {
  ...
  Calendar, RefreshCw, Building2, TrendingUp, CheckCircle2,
} from "lucide-react";
import {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Download, schedule and manage governance reports
            </p>
          </div>
          <button className="flex items-center gap-2 px-3 py-2 rounded-lg bg-primary text-primary-foreground text-xs font-medium hover:bg-primary/80 transition-colors">
            <Download size={13} />
            Generate Report
          </button>
        </div>
        ...
        <Card className="border-border bg-gradient-to-r from-primary/5 to-transparent">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm flex items-center gap-2">
              ...
              <span className="text-[10px] text-muted-foreground ml-auto">Jun 21 – Jun 27, 2024</span>
            </CardTitle>
          </CardHeader>
